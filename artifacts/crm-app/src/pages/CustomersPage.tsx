  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <input type="text" value={form.address} onChange={(e) => onChange("address", e.target.value)} placeholder="Village / Address" className={inputCls} />
      </div>
    </div>
  );
}
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-100 bg-gray-50/50 text-left">
                {["Name", "Phone", "Address", "Added", "Actions"].map((h) => (
